...
public class GoogleStepsDefinitions {
    ...
    public void userShouldSeeSixLinksInTheFooter(List<String> ListLinks) {



        int expectedSize = ListLinks.size();
        int actaulSize = googleSearchPage.link.size();

        System.out.println("List of Links: "+ListLinks );

        Assert.assertEquals(actaulSize,expectedSize);
